...
public class Player : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        rightLobAngleTan = MathF.Tan(rightLobAngle);
    }
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButton(1) && shooting)
        {
            ...
            normalizedSideToSide = camTrans.forward.normalized;

            Vector3 prelimVel = normalizedSideToSide * chargedVelocity;
            prelimVel += chargedVelocity * rightLobAngleTan * Vector3.up;
        ...
        if (Input.GetMouseButtonUp(1) && shooting) //mouse up, shoot
        {
            ...
            ballRB.velocity += chargedVelocity * rightLobAngleTan * Vector3.up;
